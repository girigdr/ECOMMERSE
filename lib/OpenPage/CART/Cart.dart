...
import 'CartApi.dart';
import 'CartProductView.dart';
import 'package:flutter/material.dart';

class CartList extends StatefulWidget {
    String user ;
   CartList({super.key , required this.user });
...
class _CartListState extends State<CartList> {
  ...
  late Future< List < Cart > > cartProduct;

  @override
  void initState() {
    super.initState();
    cartProduct = CartApi.getAllProductsByUserId( widget.user ) ;
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      future: cartProduct, // Use FutureBuilder to wait for the data
      ...
      children: [
        InkWell(
          onTap: () {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => ProductviewCart( product : widget.product[ widget.ind ] , ind : widget.ind , user : widget.user) ),
            );
          },
          child: Container(
                          ...
                          itemBuilder: (context, index) {
                            return Hero(
                              ...
                              //   borderRadius: BorderRadius.all(Radius.circular(10)),
                                ...
                                //   fit: BoxFit.contain,
                                tag: '${widget.ind}',
                                  child: Image.network( widget.product[ widget.ind ].imageList[ index ] ) ,//images[widget.ind][ index ]),
                              //   ),
                              // ),
                            );
                          },
