...
class ProductviewCart extends StatefulWidget {
  Cart product ; int ind ; String user ;
  ProductviewCart({super.key , required this.product ,required this.ind,required this.user} );
            ...
            children: [
              ...
              Stack(
                children: [
                  ...
                  GestureDetector(
                    onTap: () async {
                      await CartApi.deleteProductFromCart( context , widget.user ,widget.product.id ) ;
                    },
                    child : Container(
                      height: max( h , w ) / 18 ,
                      width: w / 1.3,
